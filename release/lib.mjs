...
export function artifactKey(artifact, release) {
  ...
  invariant(typeof artifact.location === 'string' && /^https:\/\/downloads\.anon\.inc\/[A-Za-z0-9._/-]+$/.test(artifact.location), 'Unexpected artifact location');
  const key = artifact.location.slice('https://downloads.anon.inc/'.length);
